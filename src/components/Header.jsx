        ...
        <header className={darkMode ? "dark" : ""}>
            ...
            <nav className={menuOpen ? "open" : ""}>
                ...
                <ul>
                    ...
                    <li className={`navbar ${darkMode ? "dark" : ""}`}><Link to="/sobre-nosotros" onClick={closeMenu}>Sobre Nosotros </Link></li>

                    <li className={`navbar ${darkMode ? "dark" : ""}`}><Link to="/info" onClick={closeMenu}>Más Info</Link></li>
                    <li className={`navbar ${darkMode ? "dark" : ""}`}><Link to="/contacto" onClick={closeMenu}>Contacto</Link></li>
                </ul>
            </nav>
        </header>
    );
